...
namespace HousesPeru
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IInmuebleService, InmuebleService>();
            container.RegisterType<IImageService, ImagenService>();
            container.RegisterType<IPlanService, PlanService>();
            container.RegisterType<IPublicacionService, PublicacionService>();
            container.RegisterType<IImageService, ImagenService>();
            container.RegisterType<IValidacionUsuario, ValidacionUsuario>();
            container.RegisterType<IInmuebleTipoService, InmuebleTipoService>();
            container.RegisterType<ICiudadService, CiudadService>();
            container.RegisterType<IValidacionInmueble, ValidacionInmueble>();
        }
    }
}